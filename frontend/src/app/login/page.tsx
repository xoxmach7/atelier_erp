...
export default function LoginPage() {
  ...
  if (isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[linear-gradient(135deg,#A7EAFF_0%,#60CCED_100%)]">
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[linear-gradient(135deg,#A7EAFF_0%,#60CCED_100%)] p-6">
      {/* Card */}
